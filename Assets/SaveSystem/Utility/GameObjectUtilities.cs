namespace SaveSystem.Utility {
    ...
    public static class GameObjectUtils {
        ...
        public static SaveEntity GetEntity(this Collider collider) {

            var entity = collider.GetComponent(typeof(SaveEntity)) as SaveEntity;
            ...
            return collider.GetComponentInParent(typeof(SaveEntity)) as SaveEntity;

        }

        public static SaveEntity GetEntity(this Component comp) {
            return comp.GetComponentInParent(typeof(SaveEntity)) as SaveEntity;
        }

        public static SaveEntity GetEntity(this GameObject go) {
            return go.GetComponentInParent(typeof(SaveEntity)) as SaveEntity;
        }
